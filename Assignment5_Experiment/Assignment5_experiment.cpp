...
//from the information in the struct, in alphabetical order, according 
//to the animal's name! Lastly, the program will then display the 
//information in the linear linked list. 
